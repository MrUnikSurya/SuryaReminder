...
// Decides whether a given reminder applies to today. Mirrors the same
// function in public/scheduleData.js — keep both in sync.
function isReminderDueToday(reminder, dow, dateStr) {
...
function getSchedule(scenario, dayInfo) {
...
const TAG_COLOR = { diet: "#4ade80", supp: "#a3e635", skin: "#f9a8d4", gym: "#f97316" };
const TAG_LABEL = { diet: "🥛 Diet", supp: "💊 Supplement", skin: "🧴 Skincare", gym: "🏋 Gym" };
...
const PHASE_1_START = "2026-08-18"; // Phase 1 begins (diet, skincare, study, chess)
const PHASE_2_START = "2026-09-26"; // Phase 2 begins (adds gym)


module.exports = { CATEGORY_COLORS, LEGEND, WEEKDAY_A, FRIDAY_A, WEEKEND_A, GYM_A, GYM_WEEKEND, WEEKDAY_B, FRIDAY_B, getSchedule, isGymDayForA, isReminderDueToday, SHOPPING, TAG_COLOR, TAG_LABEL, BUDGET, RULES, PHASE_1_START, PHASE_2_START };
